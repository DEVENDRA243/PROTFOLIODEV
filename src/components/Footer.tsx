      ...
      <div className="relative z-10">
        ...
        <div className="max-w-[1200px] mx-auto px-6 flex flex-col items-center text-center mb-16 md:mb-20">
          ...
          >
            ...
            <div className="absolute -inset-[1px] rounded-full accent-gradient opacity-0 group-hover:opacity-100 transition-opacity duration-300 -z-0" />
            <div className="absolute inset-[1px] rounded-full bg-bg group-hover:bg-bg/90 -z-0" />
          </a>
        </div>
        ...
        <div className="max-w-[1200px] mx-auto px-6 pt-12 border-t border-stroke/50 flex flex-col md:flex-row justify-between items-center gap-8">
          <div className="flex items-center gap-4">
            <div className="social-button">
              <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="relative block w-10 h-10 md:w-12 md:h-12 rounded-full group">
            ...
            <div className="social-button">
              <a href="https://github.com/DEVENDRA243" target="_blank" rel="noopener noreferrer" className="relative block w-10 h-10 md:w-12 md:h-12 rounded-full group">
            ...
            <div className="social-button">
              <a href="https://www.linkedin.com/in/devendrakumar03/" target="_blank" rel="noopener noreferrer" className="relative block w-10 h-10 md:w-12 md:h-12 rounded-full group">
            ...
            <div className="social-button">
              <a href="mailto:devenjsr@gmail.com" className="relative block w-10 h-10 md:w-12 md:h-12 rounded-full group">
          ...
          <div className="flex items-center gap-3 bg-surface/50 border border-stroke px-4 py-2 rounded-full">
            <div className="relative w-2 h-2">
                <div className="absolute inset-0 bg-green-500 rounded-full animate-ping opacity-75" />
                <div className="relative w-full h-full bg-green-500 rounded-full" />
            </div>
            <span className="text-[10px] text-muted uppercase tracking-[0.2em]">Available for projects</span>
          </div>
